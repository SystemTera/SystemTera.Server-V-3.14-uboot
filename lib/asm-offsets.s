...
.LFE111:
	...
	.text
.Letext0:
	.file 2 "/usr/src/u-boot/u-boot-VAR-SOM-AM33-SDK7/include/asm/u-boot.h"
	.file 3 "/usr/src/u-boot/u-boot-VAR-SOM-AM33-SDK7/include/linux/types.h"
	.file 4 "/usr/src/u-boot/u-boot-VAR-SOM-AM33-SDK7/include/net.h"
...
.LASF42:
	.ascii	"GNU C 4.8.3 -mfloat-abi=soft -marm -mno-thumb-inter"
	.ascii	"work -mabi=aapcs-linux -mword-relocations -march=ar"
	.ascii	"mv7-a -mfpu=vfpv3-d16 -mtls-dialect=gnu -g -Os -ffu"
	.ascii	"nction-sections -fdata-sections -fno-common -ffixed"
	.ascii	"-r9 -fno-builtin -ffreestanding -fno-stack-protecto"
	.ascii	"r -fstack-usage\000"
.LASF1:
...
.LASF44:
	.ascii	"/usr/src/u-boot/u-boot-VAR-SOM-AM33-SDK7\000"
.LASF8:
	.ascii	"sizetype\000"
.LASF30:
	.ascii	"recv\000"
